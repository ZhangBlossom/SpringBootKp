...
messageModel = MessageModel.CLUSTERING) //设定消息模式为集群模式 也就是选择负载均衡
public class LoadBalanceListener1 implements RocketMQListener<String> {
    ...
    public void onMessage(String msg) {
        System.out.println("我是第一个分组，集群模式，当前的组为1，消息为："+msg);
